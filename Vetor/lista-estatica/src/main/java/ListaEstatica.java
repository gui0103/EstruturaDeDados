public class ListaEstatica {
    ...
    public boolean subistitui(int valorAntigo, int valorNovo){
    ...
    public Integer contaOcorrenciaas(int numeroEscolhido){
        int contador = 0;
    ...
    public boolean adicionaInicio(int numInicio){
        var aux = 0;

        if(nroElem < vetor.length){
            vetor[nroElem] = numInicio;
